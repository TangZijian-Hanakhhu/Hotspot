/**
 * LLM invocation, file I/O helpers.
 *
 * Ported from agents-radar/src/report.ts - the LLM concurrency limiter,
 * 429 retry, and JSON repair logic are identical. Only the autoGenFooter
 * branding string differs.
 */
